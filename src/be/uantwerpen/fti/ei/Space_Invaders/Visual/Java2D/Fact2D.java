 ...
 */
public class Fact2D extends AFact {

    /**
     * De GraphicsContext voor de Java2D-implementatie.
     */
    static GraphicsContext grCtx = new GraphicsContext();
    public Game game;
     ...
     */
    public Input initialiseInput() {return new Input2D(grCtx);}
     ...
     */
    public PlayerShip makePlayerShip(double PlayerX, double PlayerY, double speed, int lives) {return new PlayerShip2D(PlayerX,PlayerY,speed,lives,grCtx);}
     ...
     */
    public Enemies makeEnemies(double curX, double curY, double speed, int lives, int enemyRangeY, int numberOfEnemies, int distance) {return new Enemies2D(curX, curY, speed, lives, enemyRangeY, numberOfEnemies, distance, grCtx);}
     ...
     */
    public BonusController makeBonusController(double curX, double curY, double speed, int lives) {return new BonusController(curX, curY, speed, lives);}
     ...
     */
    public MeteoriteController makeMeteoriteController(double curX, double curY, double speed, int lives) {return new MeteoriteController(curX, curY, speed, lives);}
     ...
     */
    public Bonus makeBonus(double curX, double curY, double speed, int lives) {return new Bonus2D(curX, curY, speed, lives, grCtx);}
     ...
     */
    public Meteorite makeMeteorite(double curX, double curY, double speed, int lives) {return new Meteorite2D(curX, curY, speed, lives, grCtx);}
     ...
     */
    public PlayerBlast makePlayerBlast(double curX, double curY, double speed, int lives) {return new PlayerBlast2D(curX, curY, speed, lives, grCtx);}
     ...
     */
    public EnemyBlast makeEnemyBlast(double curX, double curY, double speed, int lives) {return new EnemyBlast2D(curX, curY, speed, lives, grCtx);}
     ...
     */
    public PlayerController makePlayerController(double curX, double curY, double speed, int lives) {return new PlayerController(curX, curY, speed, lives);}
     ...
     */
    public EnemyController makeEnemyController(double curX, double curY, double speed, int lives) {return new EnemyController(curX, curY, speed, lives);}

    /**
     * Stelt de dimensies van de game in voor de GamePanel.
     * @param gamecellsx Het aantal gamecellen in de x-richting.
     * @param gamecellsy Het aantal gamecellen in de y-richting.
     */
    ...
    /**
     * Maakt een Java2D-implementatie van SoundSystem.
     * @return Een be.uantwerpen.fti.ei.Space_Invaders.Visual.Java2D.SoundComponent-object dat de Java2D-implementatie van SoundSystem vertegenwoordigt.
     */
    public SoundSystem makeSoundSystem() {return new be.uantwerpen.fti.ei.Space_Invaders.Visual.Java2D.SoundComponent();}

    /**
     * Maakt een Java2D-implementatie van AGameText.
     * @return Een GameText2D-object dat de Java2D-implementatie van AGameText vertegenwoordigt.
     */
    public AGameText makeGameText() {return new GameText2D(grCtx);}
}
